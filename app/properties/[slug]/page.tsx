...
export default async function PropertyDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="px-4 py-6 md:px-8 md:py-8">
      <Link href="/annual-property-reviews" className="inline-flex items-center rounded-lg border border-anchor-border bg-white px-3 py-2 text-sm text-anchor-body hover:border-slate-500 hover:text-anchor-text">
